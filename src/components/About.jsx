          ...
          <div className="w-full">
            ...
            <div className="flex justify-center mb-12 gap-2 flex-wrap">
              {['story', 'experience', 'philosophy'].map((tab) => (
                <button
                  ...
                  className={`px-6 py-3 rounded-full border transition-all duration-300 capitalize ${
                    activeTab === tab
            ...
            <div className="mt-8">
              ...
              {activeTab === 'philosophy' && (
                ...
                >
                  <div className="bg-gradient-to-br from-purple-900/20 to-pink-900/20 backdrop-blur-xl rounded-2xl border border-white/10 p-12">
